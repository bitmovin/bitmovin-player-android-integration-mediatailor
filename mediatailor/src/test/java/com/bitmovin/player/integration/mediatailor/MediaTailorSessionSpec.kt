...
class MediaTailorSessionSpec : UnitSpec({
        ...
        describe("when the post request is successful") {
            ...
            it("returns a successful SessionInitializationResult") {
                val result = mediaTailorSession.initialize(
                    MediaTailorSessionConfig(
                        sessionInitUrl = testSessionInitUrl,
                ...
                expectThat(result)
                    ...
                    .and { get { manifestUrl }.isEqualTo(fakeManifestUrl) }
            }
            ...
            describe("when the player is loaded") {
                ...
                beforeEach {
                    ...
                    coEvery { httpClient.post(testSessionInitUrl) } returns HttpRequestResult.Success(
                        body = successfulSessionInitResponse
                    )
                    coEvery { httpClient.get(fakeTrackingUrl) } returns HttpRequestResult.Success(
...
private const val testSessionInitUrl = "https://example.com/session-init"
private const val fakeTrackingUrl = "https://example.com/tracking"
private const val fakeManifestUrl = "https://example.com/manifest.m3u8"
